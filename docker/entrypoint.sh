...
then
  ...
  mysql -D $MYSQL_DATABASE -e "UPDATE \`user\` SET \`UserName\`='hhglobal', \`UserPassword\`='5f4dcc3b5aa765d61d8327deb882cf99' WHERE \`UserID\` = 1 LIMIT 1"
...
# Enable SSL in production mode
# if [ "$CMS_DEV_MODE" == "false" ]
# then
#      a2enmod ssl
#      a2ensite hhgj-ds.conf
